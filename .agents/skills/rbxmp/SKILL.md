---
name: perf-profiling
description: Analyze fine-grained performance data provided by the MicroProfiler through the rbxmp Luau module. Use it to investigate CPU and GPU bottlenecks, identify the causes of frame-time spikes, and analyze memory allocations by subsystem.
---
...
- _Human-friendly reference:_ https://github.com/Roblox/libmp/blob/main/docs/ALL-SCOPES.md
- _AI-readable source:_ https://github.com/Roblox/libmp/releases/download/latest/ALL-SCOPES.md

_(When writing scripts for deep capture analysis, monitor your script's execution time. If it takes excessively long, look for optimizations in your Luau script to speed up future runs)._
...
_Specific to `CounterSampleArray`:_
